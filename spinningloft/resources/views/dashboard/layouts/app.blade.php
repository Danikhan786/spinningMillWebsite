...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{route('adminProperty')}}">
                    {{-- <i class="fas fa-fw fa-tachometer-alt"></i> --}}
                    <span>Property</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="{{route('propertyInquery')}}">
                    {{-- <i class="fas fa-fw fa-tachometer-alt"></i> --}}
                    <span>Property Inquery</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="{{route('gellAllContacts')}}">
                    {{-- <i class="fas fa-fw fa-tachometer-alt"></i> --}}
                    <span>Contact</span></a>
            </li>
